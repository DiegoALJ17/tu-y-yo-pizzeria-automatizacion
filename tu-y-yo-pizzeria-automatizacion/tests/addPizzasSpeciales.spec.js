...
test.describe('Agregar Pizza 2 SABORES ESPECIALES al Carrito ', () => {

  let navigationHelper;
  let modalHelper;

  test.beforeEach(async ({ homePage, alertModalPage, page }) => {
    logger.info(' Iniciando test de pizza 2 SABORES ESPECIALES refactorizado');
  ...
  test('TC-AUTOMATIZADO-016 - Agregar pizza especial con configuración completa', async ({ page }) => {
    test.setTimeout(120000);
    
    logger.testStart('TC-AUTOMATIZADO-016  - Pizza 2 Sabores Especiales completa');
    
    TestHelpers.addAllureInfo(
      test,
      'Agregar pizza 6 Porciones 2 Sabores Especiales: Tú y Yo + Americana, con extra de Queso, dato extra y cantidad 3',
      'critical'
    );
    ...
    const config = {
      pizzaName: '4 Porciones 2 Sabores Especiales',
      //sabor1: 'TÚ Y YO',
      sabor2: 'AMERICANA',
      extra: 'Queso',
    ...
    // PASO 1: Navegar a 2 Sabores Especiales
   
    await test.step('Navegar a sección 2 Sabores Especiales', async () => {
      logger.step('Navegando a 2 SABORES Especiales');
      
      await navigationHelper.navigateToCategory('pizzasEspeciales');
      
      logger.success(' Sección 2 SABORES Especiales cargada');
    });

  
    // PASO 2: Abrir modal de Pizza 2 Sabores
    
    await test.step('Abrir modal de Pizza 2 Sabores Especiales', async () => {
    ...
    // PASO 5: Seleccionar segundo sabor Especial
    ...
    await test.step('Agregar pizza al carrito', async () => {
      ...
      logger.success(' Pizza 2 Sabores Especiales agregada al carrito');
    });
    ...
    logger.testEnd('TC-AUTOMATIZADO-016 - Pizza 2 Sabores Especiales completa', 'PASSED');
  });

 
  // TEST 2: Flujo con múltiples extras

  test('TC-AUTOMATIZADO-017 - Agregar pizza especial con múltiples extras', async ({ page }) => {
    test.setTimeout(120000);
    
    logger.testStart('TC-AUTOMATIZADO-017 - Pizza 2 Sabores con múltiples extras');
    
    TestHelpers.addAllureInfo(
      test,
      'Pizza 2 Sabores: Carnívora + Pepperoni, múltiples extras (Queso, Embutidos), dato extra y cantidad 2',
      'high'
    );
    ...
    logger.testEnd('TC-AUTOMATIZADO-017 - Múltiples extras', 'PASSED');
  });

  
  // TEST 3: Flujo mínimo (sin extras)
 
  test('TC-AUTOMATIZADO-018 - Agregar pizza especial configuración mínima ', async ({ page }) => {
    test.setTimeout(130000);
    
    logger.testStart('TC-AUTOMATIZADO-018 - Pizza 2 Sabores mínima');
    ...
    logger.testEnd('TC-AUTOMATIZADO-018 - Configuración mínima', 'PASSED');
  });
